#!/usr/bin/env python3
"""Drop-test beam part using SDF (Signed Distance Field) collision.

Headless IsaacGym script that drops a part onto the table and captures frames.

Usage:
    python fabrica/debug_sdf.py --part 2
    python fabrica/debug_sdf.py --part 6 --num-frames 500
"""
...
def main():
    ...
    parser.add_argument("--output-dir", type=str, default="debug_output/sdf")
    ...
    beam_file = f"beam_{args.part}_sdf.urdf"
    ...
    print(f"SDF beam: {gym.get_asset_rigid_body_count(beam_asset)} bodies, "
    ...
    # Set SDF shape properties: thickness=0.0
