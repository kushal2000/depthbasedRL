...
RESET_POSITION_CENTER_X="${RESET_POSITION_CENTER_X:-0.160}"
...
RESET_ORIENTATION_YAW_RANGE_DEG="${RESET_ORIENTATION_YAW_RANGE_DEG:-12.0}"
RESET_ORIENTATION_AXIS_ANGLE_RANGE_DEG="${RESET_ORIENTATION_AXIS_ANGLE_RANGE_DEG:-0.0}"
HOLE_X_RANGE="${HOLE_X_RANGE:--0.130 -0.110}"
