...
RESET_POSITION_CENTER_X="${RESET_POSITION_CENTER_X:-0.0}"
RESET_POSITION_CENTER_Y="${RESET_POSITION_CENTER_Y:-0.07}"
RESET_POSITION_NOISE_X="${RESET_POSITION_NOISE_X:-0.015}"
...
RESET_ORIENTATION_YAW_RANGE_DEG="${RESET_ORIENTATION_YAW_RANGE_DEG:-0.0}"
RESET_ORIENTATION_AXIS_ANGLE_RANGE_DEG="${RESET_ORIENTATION_AXIS_ANGLE_RANGE_DEG:-0.0}"
HOLE_X_RANGE="${HOLE_X_RANGE:-0.0 0.0}"
HOLE_Y_RANGE="${HOLE_Y_RANGE:--0.08 -0.08}"
HOLE_YAW_RANGE_DEG="${HOLE_YAW_RANGE_DEG:-0.0}"
