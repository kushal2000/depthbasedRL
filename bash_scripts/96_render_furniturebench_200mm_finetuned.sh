...
BACKDROP_HORIZON_COLOR_R="${BACKDROP_HORIZON_COLOR_R:-0.50}"
BACKDROP_HORIZON_COLOR_G="${BACKDROP_HORIZON_COLOR_G:-0.66}"
BACKDROP_HORIZON_COLOR_B="${BACKDROP_HORIZON_COLOR_B:-0.86}"
...
BACKDROP_Y="${BACKDROP_Y:-2.2}"
BACKDROP_WIDTH="${BACKDROP_WIDTH:-14.0}"
