        ...
        json.dump(
            {
                ...
                "camera_pos_jitter": env.camera_pos_jitter.tolist(),
                "camera_rot_jitter_wxyz": env.camera_rot_jitter_wxyz.tolist(),
                "camera_world_pos": env.camera_world_pos.tolist(),
                "camera_world_quat_wxyz": env.camera_world_quat_wxyz.tolist(),
