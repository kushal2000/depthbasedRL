...
def _style_scene_for_video(env, args) -> dict[str, Any]:
    ...
    summary["floor"] = _apply_pbr_tile_floor(
        ...
        texture_path=str(DEFAULT_SOFT_CONCRETE_TEXTURE),
        normal_texture_path=str(DEFAULT_SOFT_CONCRETE_NORMAL),
        texture_scale=float(args.floor_texture_scale),
        roughness=float(args.floor_roughness),
        normal_texture_influence=float(args.floor_normal_strength),
        specular_level=float(args.floor_specular_level),
        material_name="FurnitureBenchSoftConcrete",
    ...
    summary["sun"] = _apply_single_sun_lighting(
        ...
        color=tuple(float(v) for v in args.single_sun_color),
        elevation_deg=float(args.single_sun_elevation_deg),
    )
    return summary
...
def main() -> None:
    ...
    parser.add_argument("--floor_tile_count", type=int, default=1)
    parser.add_argument("--floor_tile_size", type=float, default=120.0)
    parser.add_argument("--floor_tile_gap", type=float, default=0.0)
    parser.add_argument("--floor_texture_scale", type=float, default=8.0)
    parser.add_argument("--floor_roughness", type=float, default=0.92)
    parser.add_argument("--floor_normal_strength", type=float, default=0.05)
    parser.add_argument("--floor_specular_level", type=float, default=0.04)
    ...
    parser.add_argument("--backdrop_y", type=float, default=50.0)
    parser.add_argument("--backdrop_width", type=float, default=180.0)
    ...
    parser.add_argument("--single_sun_color_temperature", type=float, default=5150.0)
    parser.add_argument("--single_sun_color", type=float, nargs=3, default=(1.0, 0.965, 0.87))
    parser.add_argument("--single_sun_elevation_deg", type=float, default=48.0)
    parser.add_argument("--single_sun_yaw_offset_deg", type=float, default=105.0)
    parser.add_argument("--image_exposure", type=float, default=-0.20)
    parser.add_argument("--image_contrast", type=float, default=1.08)
    parser.add_argument("--image_saturation", type=float, default=1.06)
    parser.add_argument("--image_gamma", type=float, default=0.98)
