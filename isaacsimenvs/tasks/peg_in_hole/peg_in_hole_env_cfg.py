...
class PegInHoleCfg:
    ...
    # Deployment/debug-only: keep the wooden table but remove the hole/fixture
    # geometry from the baked scene URDFs before USD conversion.
    hide_hole_fixture: bool = False
